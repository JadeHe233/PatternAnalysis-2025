...
plt.bar(range(6), mean_dice_per_class, yerr=std_dice_per_class, capsize=4, color=["gray","lightblue","gold","lime","orange","red"])
...
plt.savefig("Figures/dice_per_class.png", dpi=300, bbox_inches="tight")
plt.show()